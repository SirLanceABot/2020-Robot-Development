...
public class Shooter 
{
  ...
  private enum Transition 
  {
    ...
    Transition_08(State.Off,                    Event.FirstBallOnTarget,                State.Off),
    Transition_09(State.Off,                    Event.FirstBallOffTarget,               State.Off),
    Transition_10(State.Off,                    Event.ClipEmpty,                        State.Off),
    ...
    Transition_18(State.Searching,              Event.FirstBallOnTarget,                State.Off),
    Transition_19(State.Searching,              Event.FirstBallOffTarget,               State.Off),
    Transition_20(State.Searching,              Event.ClipEmpty,                        State.Off),
    ...
    Transition_28(State.Aligning,               Event.FirstBallOnTarget,                State.Off),
    Transition_29(State.Aligning,               Event.FirstBallOffTarget,               State.Off),
    Transition_30(State.Aligning,               Event.ClipEmpty,                        State.Off),
    ...
    Transition_38(State.Calculating,            Event.FirstBallOnTarget,                State.Off),
    Transition_39(State.Calculating,            Event.FirstBallOffTarget,               State.Off),
    Transition_40(State.Calculating,            Event.ClipEmpty,                        State.Off),
    ...
    Transition_48(State.SettingTrajectory,      Event.FirstBallOnTarget,                State.Off),
    Transition_49(State.SettingTrajectory,      Event.FirstBallOffTarget,               State.Off),
    Transition_50(State.SettingTrajectory,      Event.ClipEmpty,                        State.Off),
    ...
    Transition_56(State.PreShotCheck,           Event.PreShotCheckPassed,               State.ShootingOneBall),
    Transition_57(State.PreShotCheck,           Event.PreShotCheckFailed,               State.PreShotCheck),
    Transition_58(State.PreShotCheck,           Event.FirstBallOnTarget,                State.Off),
    Transition_59(State.PreShotCheck,           Event.FirstBallOffTarget,               State.Off),
    Transition_60(State.PreShotCheck,           Event.ClipEmpty,                        State.Off),
    Transition_61(State.ShootingOneBall,        Event.VisionAssistButtonPressed,        State.Off),
    Transition_62(State.ShootingOneBall,        Event.TapeFound,                        State.Off),
    Transition_63(State.ShootingOneBall,        Event.AlignedWithTape,                  State.Off),
    Transition_64(State.ShootingOneBall,        Event.ValuesCalulated,                  State.Off),
    Transition_65(State.ShootingOneBall,        Event.TrajectorySet,                    State.Off),
    Transition_66(State.ShootingOneBall,        Event.PreShotCheckPassed,               State.Off),
    Transition_67(State.ShootingOneBall,        Event.PreShotCheckFailed,               State.Off),
    Transition_68(State.ShootingOneBall,        Event.FirstBallOnTarget,                State.ShootingRestOfClip),
    Transition_69(State.ShootingOneBall,        Event.FirstBallOffTarget,               State.UserCorrection),
    Transition_70(State.ShootingOneBall,        Event.VisionAssistButtonPressed,        State.Off),
    ...
    Transition_78(State.UserCorrection,         Event.FirstBallOnTarget,                State.Off),
    Transition_79(State.UserCorrection,         Event.FirstBallOffTarget,               State.Off),
    Transition_80(State.UserCorrection,         Event.ClipEmpty,                        State.Off),
    Transition_81(State.ShootingRestOfClip,     Event.VisionAssistButtonPressed,        State.Off),
    Transition_82(State.ShootingRestOfClip,     Event.TapeFound,                        State.Off),
    Transition_83(State.ShootingRestOfClip,     Event.AlignedWithTape,                  State.Off),
    Transition_84(State.ShootingRestOfClip,     Event.ValuesCalulated,                  State.Off),
    Transition_85(State.ShootingRestOfClip,     Event.TrajectorySet,                    State.Off),
    Transition_86(State.ShootingRestOfClip,     Event.PreShotCheckPassed,               State.Off),
    Transition_87(State.ShootingRestOfClip,     Event.PreShotCheckFailed,               State.Off),
    Transition_88(State.ShootingRestOfClip,     Event.FirstBallOnTarget,                State.Off),
    Transition_89(State.ShootingRestOfClip,     Event.ClipEmpty,                        State.Off),
    Transition_90(State.ShootingRestOfClip,     Event.VisionAssistButtonPressed,        State.Off);
